...
async def add_new_component(component_data: SComponents
                            #, user: Users = Depends(get_current_admin_user)
                            ):
...
async def update_specific_component(component_id: int, new_component: SComponents
                                    #, user: Users = Depends(get_current_admin_user)
                                    ):
...
async def remove_component(component_id: int
                           #, user: Users = Depends(get_current_admin_user)
                           ):
